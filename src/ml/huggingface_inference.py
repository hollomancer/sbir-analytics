...
class HuggingFaceInferenceClient:
    ...
    Example:
        >>> client = HuggingFaceInferenceClient("allenai/specter2")
    ...
    def __init__(
        ...
        Args:
            model_name: HuggingFace model identifier (e.g., "allenai/specter2")
...
class LocalGPUClient:
    ...
    Example:
        >>> client = LocalGPUClient("allenai/specter2")
        >>> embeddings = client.generate_embeddings(["Text 1", "Text 2"])
    """
    ...
    def generate_embeddings(
        ...
        Example:
            >>> client = LocalGPUClient("allenai/specter2", device="cuda")
