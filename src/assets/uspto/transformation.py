"""USPTO transformation assets.

This module contains:
- JoinedRow: Data class for joined assignment rows
- USPTOAssignmentJoiner: Joiner utility for combining USPTO tables
- transformed_patent_assignments: Transform raw assignments into structured data
- transformed_patents: Aggregate patent-level data
- transformed_patent_entities: Extract entities from assignments
- uspto_transformation_success_check: Check transformation success rate
- uspto_company_linkage_check: Check company linkage quality
"""
