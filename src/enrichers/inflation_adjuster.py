...
class InflationAdjuster:
    ...
    def get_deflator_value(self, year: int) -> Optional[float]:
    ...
    def interpolate_deflator(self, year: int) -> Optional[float]:
    ...
    def extrapolate_deflator(self, year: int) -> Optional[float]:
    ...
    def get_inflation_factor(self, from_year: int, to_year: Optional[int] = None) -> tuple[Optional[float], List[str]]:
    ...
    def extract_award_year(self, award_row: pd.Series) -> Optional[int]:
    ...
    def adjust_single_award(self, award_row: pd.Series, target_year: Optional[int] = None) -> InflationAdjustmentResult:
    ...
    def adjust_awards_dataframe(self, awards_df: pd.DataFrame, target_year: Optional[int] = None) -> pd.DataFrame:
        ...
        logger.info(f"Inflation adjustment complete:")
