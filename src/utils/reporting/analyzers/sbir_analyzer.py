...
class SbirEnrichmentAnalyzer(ModuleAnalyzer):
    ...
    def _calculate_field_coverage(self, enriched_df: pd.DataFrame, original_df: Optional[pd.DataFrame]) -> Dict[str, float]:
    ...
    def _calculate_completeness_comparison(self, enriched_df: pd.DataFrame, original_df: Optional[pd.DataFrame]) -> Dict[str, Any]:
        """Calculate before/after completeness comparison.
    ...
    def _calculate_data_hygiene(self, enriched_df: pd.DataFrame, original_df: Optional[pd.DataFrame]) -> DataHygieneMetrics:
    ...
    def _calculate_changes_summary(self, enriched_df: pd.DataFrame, original_df: Optional[pd.DataFrame]) -> Optional[ChangesSummary]:
