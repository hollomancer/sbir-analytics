...
award scope beside the synthetic solicitation need, lists what the public
records show about the connection, explains why the pair was surfaced, and
ends with a class-specific representative check. The screening result stays
secondary — it orders leads for review and is not a probability or an
