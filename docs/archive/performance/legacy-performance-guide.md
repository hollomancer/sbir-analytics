# Performance Playbook (Historical Snapshot)

> Archived because its benchmark figures, hardware assumptions, and CI behavior
> are point-in-time observations. Use the current
> [performance runbook](../../performance.md) for measurements.
