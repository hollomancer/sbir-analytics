...
**2. Observable commercialization is at least one award in four — and even that is a floor, not a rate.** Flag-based channels show 17.4% of awards with a commercialization signal; recovering the awards mislabeled by the FPDS coding gap and resolving no-UEI identities lift the observable share to 28.1% (Findings 3–4). The remaining 71.9% is dominated by measurement failure rather than proven failure: sub-threshold acquisitions and licensing are invisible, and 66% of the firms counted as "disappeared" show post-award activity evidence once patents, trademarks, subawards, renamed/acquired identities, and sector registries are stacked together (Finding 3). Commercialization can be demonstrated for more than one award in four; failure can be demonstrated for almost none.
