...
**2. Observable commercialization is at least one award in four — and even that is a floor, not a rate.** Flag-based channels show 17.4% of awards with a commercialization signal; recovering the awards mislabeled by the FPDS coding gap and resolving no-UEI identities lift the observable share to 28.1% (Findings 3–4). The remaining 71.9% is dominated by measurement failure rather than proven failure: sub-threshold acquisitions and licensing are invisible, and half of the firms counted as "disappeared" were provably filing patent applications after their awards at high confidence — one in five filed trademarks, direct going-to-market evidence (Finding 3). Commercialization can be demonstrated for more than one award in four; failure can be demonstrated for almost none.
