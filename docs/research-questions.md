...
- How much undercount exists in Phase III coding by agency? Corroborated by GAO [L14] and NASEM [L1][L3]. FPDS Element 10Q (`research`, SR3/ST3) drives the **status-denial flags** product: [../specs/product-1-status-denial-flags/](../specs/product-1-status-denial-flags/). **First result (M0a, DoD FY2016–2025):** of 962 contracts described "SBIR PHASE III", **14.7% (141) lack the SR3/ST3 code** (Navy/DCMA 19%, Army 15%, AF 13%; spot-verified 12/12 vs FPDS) — a **lower bound** (description finds only ~12% of the 6,351 coded Phase III awards). Phase III solicitation monitoring: [../specs/phase-3-solicitation-alerts/](../specs/phase-3-solicitation-alerts/). **[Answerable now for the description-obvious subset (14.7% lower-bound undercount); full inferential undercount needs the 8,090-firm universe pull]** *(deps: ER, ID)* *(branch: claude/phase3-detection-phase0)*
