...
- How much undercount exists in Phase III coding by agency? Corroborated by GAO [L14] and NASEM [L1][L3]. The research protocol and its current evidence limits are documented in [the Phase III match benchmark](../specs/phase3-match-benchmark/); it depends on award-grade identity/grain (issue #447 / PR #449), while production source lifecycle belongs to issue #442. Phase III solicitation monitoring: [../specs/phase-3-solicitation-alerts/](../specs/phase-3-solicitation-alerts/). *(deps: ID)*
