...
# Via CLI
docker compose exec app dagster asset materialize -m sbir_analytics.definitions
```
...
See [Configuration Patterns](../steering/configuration-patterns.md) for complete reference.
...
- [Configuration Patterns](../steering/configuration-patterns.md) - Environment variable overrides
...
- [Configuration Patterns](../steering/configuration-patterns.md) - Configuration reference
