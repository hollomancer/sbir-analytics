...
import os
from sbir_etl.loaders.neo4j_client import Neo4jClient, Neo4jConfig
from sbir_etl.loaders.cet_loader import CETLoader, CETLoaderConfig
...
def main():
    ...
    assert (m_comp_rel.errors or 0) == 0, (
        f"Errors creating Company->CET relationships: {m_comp_rel.errors}"
    )
    ...
    with client.session() as session:
        ...
        assert rec and rec["pid"] == "artificial_intelligence", (
            "Award enrichment missing or incorrect"
        )
