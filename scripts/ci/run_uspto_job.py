...
def main() -> int:
    ...
    try:
        ...
        from sbir_etl.assets.jobs.uspto_job import uspto_validation_job  # type: ignore
    except Exception:
        logger.error("Failed to import `uspto_validation_job` from sbir_etl.assets.jobs.uspto_job")
