...
Usage:
    python scripts/archive/data/analyze_form_d_tiers.py
    python scripts/archive/data/analyze_form_d_tiers.py --input data/form_d_details.jsonl
    python scripts/archive/data/analyze_form_d_tiers.py --output-dir data/analysis
"""
