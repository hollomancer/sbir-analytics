...
Usage:
    python scripts/archive/data/analyze_sbir_ma_exits.py
    python scripts/archive/data/analyze_sbir_ma_exits.py data/sbir_ma_events.jsonl /tmp/sbir_awards_full.csv
"""
