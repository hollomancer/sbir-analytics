...
Usage:
    ...
    python scripts/archive/data/fetch_form_d_details.py

    # Latest filing only (faster)
    python scripts/archive/data/fetch_form_d_details.py --latest-only

    # Resume from partial run
    python scripts/archive/data/fetch_form_d_details.py --resume
