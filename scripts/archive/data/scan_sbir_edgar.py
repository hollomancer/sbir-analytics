...
Usage:
    ...
    python scripts/archive/data/scan_sbir_edgar.py --awards /tmp/sbir_awards_full.csv
    ...
    python scripts/archive/data/scan_sbir_edgar.py --awards /tmp/sbir_awards_full.csv --limit 1000
"""
