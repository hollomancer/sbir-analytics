...
def main():
    ...
    for award in awards:
        ...
        for detection in detections:
            contract_id = detection.primary_contract.contract_id if detection.primary_contract else "N/A"
        print(f"    - {contract_id}: score={detection.likelihood_score:.3f}, confidence={detection.confidence}")
