...
class TestVendorResolution:
    ...
    def vendor_crosswalk(self):
        ...
        from sbir_etl.transition.features.vendor_crosswalk import CrosswalkRecord, VendorCrosswalk
...
class TestNeo4jOperations:
    ...
    def test_neo4j_transition_node_creation(self):
        ...
        from sbir_etl.loaders.transition_loader import TransitionLoader
