"""Tests for cet company relationships."""
...
from sbir_analytics.loaders.neo4j import CETLoader, LoadMetrics  # type: ignore
...
def test_asset_neo4j_company_cet_relationships_invokes_loader(monkeypatch, tmp_path):
    ...
    from sbir_analytics.assets.cet.loading import loaded_company_cet_relationships as asset_fn
