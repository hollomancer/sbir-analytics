...
from sbir_ml.tools.phase0.resolve_entities import ResolveEntitiesTool, _normalize_name, _generate_canonical_id
...
class TestExtractSAMEntitiesTool:
    ...
    def test_import(self):
        from sbir_ml.tools.phase0.extract_sam_entities import ExtractSAMEntitiesTool
...
class TestExtractFPDSContractsTool:
    ...
    def test_import(self):
        from sbir_ml.tools.phase0.extract_fpds_contracts import ExtractFPDSContractsTool
