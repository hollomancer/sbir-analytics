...
class TestFilterByTiming:
    ...
    def test_filter_by_timing_allows_pre_award_buffer(self, extractor):
        ...
        assert filtered[0].patent_number == "US123456"
    ...
    def test_filter_by_timing_skips_patents_without_dates(self, extractor):
        ...
        patents = [
            Patent(patent_number="US123456", title="Test", filing_date=None, assignee="Acme"),
            Patent(
                patent_number="US234567",
                title="Test",
        ...
        assert len(filtered) == 1
        assert filtered[0].patent_number == "US234567"
