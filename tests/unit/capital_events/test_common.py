...
from sbir_etl.capital_events._common import data_dir, data_path, normalize_date
...
def test_data_dir_default_when_env_unset(monkeypatch):
    ...
    # _common.py lives at sbir_etl/capital_events/_common.py;
    # parents[2] from there is the repo root; data/ is a sibling of sbir_etl/
    expected = Path(__file__).resolve().parents[3] / "data"
