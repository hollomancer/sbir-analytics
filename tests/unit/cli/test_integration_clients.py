...
from sbir_etl.cli.integration.dagster_client import DagsterClient
from sbir_etl.cli.integration.metrics_collector import MetricsCollector
from sbir_etl.cli.integration.neo4j_client import Neo4jClient
...
class TestDagsterClient:
    ...
    @patch("sbir_etl.cli.integration.dagster_client.materialize")
    @patch("sbir_etl.cli.integration.dagster_client.AssetSelection")
    def test_trigger_materialization(
        ...
        with patch("sbir_etl.cli.integration.dagster_client.AssetSelection", mock_selection_class):
            # Test
...
class TestNeo4jClient:
    ...
    @patch("sbir_etl.cli.integration.neo4j_client.GraphDatabase")
