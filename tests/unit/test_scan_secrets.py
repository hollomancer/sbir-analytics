...
class TestMatchLocations:
    ...
    def test_strips_matched_content(self):
        ...
        locations = _match_locations(["./deploy/prod.env\x0012:AWS_SECRET_ACCESS_KEY=hunter2"])
    ...
    def test_path_containing_colons_keeps_its_line_number(self):
        ...
        locations = _match_locations(["./wei:rd/x.env\x001:AWS_SECRET_ACCESS_KEY=a:b:c"])
    ...
    def test_input_without_nul_never_leaks_content(self):
        ...
        assert _match_locations(["./a.env:7:AWS_SECRET_ACCESS_KEY=hunter2"]) == ["./a.env"]
