...
HEAVY_ASSET_MODULES = {
    "sbir_etl.assets.fiscal_assets",  # R dependencies, economic modeling
    "sbir_etl.assets.paecter.embeddings",  # Sentence transformers, ML models
    "sbir_etl.assets.paecter.similarity",  # Large-scale similarity computation
    "sbir_etl.assets.ml.cet_training",  # scikit-learn, model training
    "sbir_etl.assets.ml.cet_inference",  # Model inference
    "sbir_etl.assets.ml.cet_drift_detection",  # Statistical analysis
    "sbir_etl.assets.uspto.ai_extraction",  # spaCy, NLP processing
}
