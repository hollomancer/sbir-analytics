...
def train_cet_patent_classifier() -> Output:
    ...
    try:
        from sbir_etl.ml.features.patent_features import get_keywords_map
        from sbir_etl.ml.models.dummy_pipeline import DummyPipeline
        from sbir_etl.ml.train.patent_training import train_patent_classifier
    except Exception:
...
def cet_award_training_dataset() -> Output:
    ...
    try:
        from sbir_etl.ml.data.award_training_loader import AwardTrainingLoader, save_dataset_ndjson
