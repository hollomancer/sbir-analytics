...
Usage:
    python -m sbir_etl.ucc.ca_extractor
"""
...
from sbir_etl.ucc.schema import FilingType
...
def main() -> int:
    ...
    parser.add_argument("--cohort", type=Path, default=data_path("ucc1_pilot_ca_org_cohort.jsonl"))
    parser.add_argument("--out", type=Path, default=data_path("ucc1_pilot_raw.jsonl"))
    parser.add_argument(
        "--checkpoint", type=Path, default=data_path("ucc1_pilot_extractor_checkpoint.jsonl")
    )
