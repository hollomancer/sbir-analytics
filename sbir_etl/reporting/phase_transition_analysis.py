...
Epistemic tier: exploratory. Outputs are explicitly non-citable until this
analysis earns an evidence-tier study contract.
...
def generate_phase_transition_report(
    phase_ii: Path,
    phase_iii: Path,
    pairs: Path,
    survival: Path,
    ...
    report = {
        ...
        "latency_distribution": {
            ...
            "histogram_month_bins": [{"month_bin": int(b), "n": int(n)} for b, n in histogram],
        },
        "agency_breakdown": [
            {
                "agency": a,
...
def main(argv: list[str] | None = None) -> None:
    """Run the exploratory report from command-line-style arguments."""
