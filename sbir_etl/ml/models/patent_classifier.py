...
try:
    from sbir_etl.ml.features.patent_features import PatentFeatureVector as _PatentFeatureVector
    from sbir_etl.ml.features.patent_features import extract_features as _extract_features
...
try:
    from sbir_etl.ml.features.vectorizers import create_feature_matrix_builder  # type: ignore[attr-defined]
