...
Chains: validated_sbir_awards → sec_edgar_enriched_companies
...
try:
    ...
    from ..sec_edgar_enrichment import sec_edgar_enriched_companies
    ...
    return build_job_from_spec_with_executor(
        JobSpec(
            ...
            description=(
                ...
                "then extract financials and M&A signals"
            ),
