...
HEAVY_ASSET_MODULES = {
    ...
    "sbir_analytics.assets.modernbert.embeddings",  # Sentence transformers, ML models
    "sbir_analytics.assets.modernbert.similarity",  # Large-scale similarity computation
