"""Metrics collector for pipeline performance data aggregation."""
...
class MetricsCollector:
    """Aggregates performance data from metrics JSON files."""
    ...
    def get_latest_metrics(self) -> PipelineMetrics | None:
        """Get latest aggregated pipeline metrics (last 24 hours)."""
