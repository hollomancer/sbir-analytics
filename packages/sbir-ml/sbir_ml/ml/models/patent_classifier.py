...
try:
    from sbir_ml.ml.features.patent_features import PatentFeatureVector as _PatentFeatureVector
    from sbir_ml.ml.features.patent_features import extract_features as _extract_features
