...
None. The SBA annual-report structural comparison is a release candidate. Do
not cite it until a tagged release opens its materialization gate and supplies
...
| --- | --- | --- |
| [SBA annual-report structural comparison](docs/public/sba-structural-comparison.md) | A separate blinded-role implementation reproduced 1,264/1,264 count operands; exact point interval `[1.0, 1.0]` | A successful frozen named-reader record, product-scoped materialization, owner approval, and tagged release are required |

## Reproducible research, not citable

| Study | What can be rerun | Why it is not citable |
| --- | --- | --- |
...
| Status | Meaning |
| --- | --- |
| **Citable** | Tagged study release with frozen inputs, executable result, prospective validation, reviewed claim, and open publication gate |
| **Validated, not citable** | Frozen prospective validation was run and recorded; publication or release gates remain closed |
| **Reproducible, not citable** | Declared inputs and code can rerun; validation, review, recovery, or release requirements still block citation |
