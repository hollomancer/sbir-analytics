...
| SEC Form D | The SEC describes Form D data as derived from filed structured data and Commission-generated identifiers, and says it assists analysis but is not a substitute for the filings. [Form D data](https://www.sec.gov/files/Form_D.pdf). Amendments 5–8 authorize private index acquisition, exact-key candidates, candidate XML, a limited source-field observation, and a review queue only. | Retain raw index metadata privately. Treat identifiers, names, related-person data, and predicate/review output as restricted working data; do not redistribute rows or declare an ownership change from the predicate alone. Identity adjudication remains source-bounded and private; EDGAR/EFTS and other corroborating-source acquisition remain unapproved. |
