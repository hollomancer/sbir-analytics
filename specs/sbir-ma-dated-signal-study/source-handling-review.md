...
| SEC Form D | The SEC describes Form D data as derived from filed structured data and Commission-generated identifiers, and says it assists analysis but is not a substitute for the filings. [Form D data](https://www.sec.gov/files/Form_D.pdf). Amendment 5 authorized a private 2009 Q1–2026 Q3 quarterly-index acquisition only. | Retain raw index metadata privately. Treat future identifiers, names, related-person data, and predicate output as restricted working data; do not redistribute rows or declare an ownership change from the predicate alone. XML acquisition and matching remain unapproved. |
