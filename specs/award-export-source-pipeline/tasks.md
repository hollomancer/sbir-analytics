...
- [x] 1. Inventory raw readers, provenance helpers, and active consumers.
  - Verify: the design records every active reader and why it is or is not in
    this migration.
  - Requirements: 1.4, 4.5

- [x] 2. Refactor the existing exact parser into the canonical extractor path.
  - Verify: Phase II parser and materialization tests remain byte-identical.
  - Requirements: 1.1-1.4

- [x] 3. Add pin-before-use verification.
